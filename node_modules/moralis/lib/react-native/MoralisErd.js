      ...
      return _regenerator.default.async(function (_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 23:
              user.set('erdAccounts', uniq([].concat(accounts, (_user$get = user.get('erdAccounts')) != null ? _user$get : [])));
      ...
      return _regenerator.default.async(function (_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 17:
              user.set('erdAccounts', uniq([erdAddress].concat((_user$get2 = user.get('erdAccounts')) != null ? _user$get2 : [])));
              user.set('erdAddress', erdAddress);
              _context4.next = 21;
              return _regenerator.default.awrap(user.save());
      ...
      return _regenerator.default.async(function (_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 10:
              user = _context5.sent;
              accounts = (_user$get3 = user.get('erdAccounts')) != null ? _user$get3 : [];
