...
function _objectSpread(target) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    if (i % 2) {
      ...
      _forEachInstanceProperty2(_context4 = ownKeys(Object(source), true)).call(_context4, function (key) {
      ...
      _forEachInstanceProperty2(_context5 = ownKeys(Object(source))).call(_context5, function (key) {
