...
function _objectSpread(target) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    if (i % 2) {
      ...
      _forEachInstanceProperty(_context5 = ownKeys(Object(source), true)).call(_context5, function (key) {
      ...
      _forEachInstanceProperty(_context6 = ownKeys(Object(source))).call(_context6, function (key) {
