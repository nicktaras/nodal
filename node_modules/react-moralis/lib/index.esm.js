...
var _useResolveCall = function (call, initialData, params, options, defaultAutoFetch) {
    ...
    var fetch = useCallback(function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var combinedParams, results, error_1;
...
var getMoralis = function (environment) {
    switch (environment) {
        case "browser":
...
var _useMoralisInit = function (_a) {
    var appId = _a.appId, serverUrl = _a.serverUrl, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, plugins = _a.plugins, _b = _a.environment, environment = _b === void 0 ? "browser" : _b;
    ...
    var Moralis = useMemo(function () { return getMoralis(environment); }, [environment]);
    ...
    return { isInitialized: isInitialized, isInitializing: isInitializing, Moralis: Moralis, environment: environment };
};
...
var MoralisProvider = function (_a) {
    var children = _a.children, appId = _a.appId, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, serverUrl = _a.serverUrl, plugins = _a.plugins, environment = _a.environment, _b = _a.options, _c = _b === void 0 ? {} : _b, onAccountChanged = _c.onAccountChanged;
...
var useMoralisWeb3ApiCall = function (call, params, options) {
    var result = _useResolveCall(call, null, params, options);
    return result;
};
...
export { ByMoralis, MoralisContext, MoralisProvider, NoMoralisContextProviderError, NotAuthenticatedError, ReactMoralisError, ValidationError, useMoralis, useMoralisCloudFunction, useMoralisFile, useMoralisQuery, useMoralisSubscription, useMoralisWeb3Api, useMoralisWeb3ApiCall, useNewMoralisObject, useWeb3ExecuteFunction, useWeb3Transfer };
