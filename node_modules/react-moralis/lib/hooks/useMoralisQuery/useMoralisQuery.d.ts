...
export declare const useMoralisQuery: <Entity extends MoralisType.Attributes = MoralisType.Attributes>(nameOrObject: string | MoralisType.Object, queryMap?: (q: Query<Entity>) => Query<Entity>, dependencies?: any[], options?: UseMoralisQueryOptions<Entity>) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("../_useResolveAsyncCall").ResolveCallOptions<MoralisType.Object<Entity>[], object>) => Promise<void>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
